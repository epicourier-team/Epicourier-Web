...
We aim to build an open, respectful, and responsible community around **Epicourier-v2**.
Every contributor, regardless of background or role, should feel safe to share ideas, learn, and collaborate.

We use learned AI data and user information to improve our recommendation systems, but we commit to handling all user data **securely and transparently** — never storing or sharing it in a harmful or unauthorized way.
...
Maintainers may remove or edit contributions that violate these standards, and take further action if needed to ensure a safe and professional environment.

Any code or configuration that risks **user data leakage or unethical AI behavior** will be immediately reviewed and may be reverted or rejected.
...
If you experience or witness unacceptable behavior, please report it confidentially to the maintainers at **pranshavpatel1803@gmail.com**.
...
This document was inspired by the [Contributor Covenant](https://www.contributor-covenant.org), and adapted to reflect **Epicourier-v2’s focus on ethical AI practices, privacy, and collaboration**.
